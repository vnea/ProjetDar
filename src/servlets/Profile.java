       ...
       try {
           ...
           if (gs != null) {
               ...
               if (gs.getRoot().getUsername().equals(username)) {
                   ...
                   success = false;
                   errorMessage = "Impossible de supprimer la partie.";
               }
           }
           else {
               success = false;
       ...
       try {
           ...
           if (gs != null) {
               ...
               if (username.equals(gs.getRoot().getUsername())) {
                   success = false;
                   errorMessage = "Vous ne pouvez pas quittez la partie " + gs.getLabel() + " comme vous êtes l'hébergeur de cette partie.";
               }
               else {
   ...
   private void performJoinGameSession(HttpServletRequest request) throws ServletException, IOException {
       try {
           ...
           if (gs != null) {
               ...
               if (username.equals(gs.getRoot().getUsername())) {
                   success = false;
                   errorMessage = "Vous participez déjà à la partie " + gs.getLabel() + " comme vous êtes l'hébergeur de cette partie.";
               }
               else {
